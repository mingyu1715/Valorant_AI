...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        window,
        version,
        aggregate: featureExtractionResult.aggregate
      },
      {
        headers: {
    ...
    logError("feature-snapshot", "feature snapshot API 요청이 실패했습니다.", {
    ...
    return NextResponse.json({ error: "feature snapshot 조회 중 오류가 발생했습니다." }, { status: 500 });
  }
}
